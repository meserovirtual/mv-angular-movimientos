 ...
 * @ngdoc service
 * @description
 * Servicio de generación de movimientos contables.
 */
(function () {

    'use strict';
    // URL de acceso al servicio
    var url = window.installPath + '/mv-angular-movimientos/includes/movimientos.php';

    angular.module('mvMovimientos', ['mvMovimientosList'])
        .service('MovimientoStockFinal', [function () {
            this.stocks_finales = [];
        }])
        .factory('MovimientosService', MovimientosService);


    MovimientosService.$inject = ['$http', 'MovimientosList', 'MovimientoStockFinal'];
    /**
     * Función para el armado de los movimientos.
     *
     * Tipos:
     ...
     * @param MovimientoStockFinal
     * @returns {{}}
     * @constructor
     */
    function MovimientosService($http, MovimientosList, MovimientoStockFinal) {
        var vm = this;
